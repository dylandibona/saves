  ...
  public: {
    Tables: {
      captures: {
        ...
        Relationships: [
          {
            foreignKeyName: "captures_recommender_id_fkey"
          ...
          {
            foreignKeyName: "captures_save_id_fkey"
            columns: ["save_id"]
            isOneToOne: false
      ...
      map_syncs: {
        ...
        Relationships: [
          {
            foreignKeyName: "map_syncs_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      merge_proposals: {
        ...
        Relationships: [
          {
            foreignKeyName: "merge_proposals_candidate_save_id_fkey"
            columns: ["candidate_save_id"]
            isOneToOne: false
            referencedRelation: "saves"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "merge_proposals_household_id_fkey"
            columns: ["household_id"]
            isOneToOne: false
            referencedRelation: "households"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "merge_proposals_inbound_message_id_fkey"
      ...
      recommenders: {
        ...
        Relationships: [
          {
            foreignKeyName: "recommenders_household_id_fkey"
            columns: ["household_id"]
            isOneToOne: false
            referencedRelation: "households"
            referencedColumns: ["id"]
      ...
      save_tags: {
        ...
        Relationships: [
          {
            foreignKeyName: "save_tags_added_by_fkey"
            columns: ["added_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      saves: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "saves_merged_into_id_fkey"
      ...
      variations: {
        ...
        Relationships: [
          {
            foreignKeyName: "variations_capture_id_fkey"
            columns: ["capture_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "variations_save_id_fkey"
            columns: ["save_id"]
            isOneToOne: false
            referencedRelation: "saves"
            referencedColumns: ["id"]
